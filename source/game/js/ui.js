      ...
      $.fn.JSNESUI = function (roms) {
          ...
          var UI = function (nes) {
              ...
              self.buttons = {
                  ...
                  sound: $('<input type="button" value="寮€鍚０闊�?" class="nes-enablesound">').appendTo(self.controls),
                  zoom: $('<!--<input type="button" value="鏀惧ぇ" class="nes-zoom">-->').appendTo(self.controls)
              };
              ...
              self.buttons.zoom.click(function () {
                  if (self.zoomed) {
                      ...
                      self.buttons.zoom.attr("value", "鏀惧ぇ");
                      self.zoomed = true;
                  } else {
                      //                        self.screen.animate({
                      //                            width: '256px',
                      //                            height: '240px'
                      //                        });
                      self.buttons.zoom.attr("value", "缂╁�?");
